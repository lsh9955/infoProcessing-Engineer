...
> 모듈  
>  하나의 소프트웨어 또는 하드웨어 단위, 소프트웨어 설계에서 **기능 단위**로 분해해 추상화되어 **재사용 및 공유가 가능**한 단위  
> 모듈화  
>  모듈을 통해 소프트웨어의 성능을 향상 시키고 디버깅, 수정, 통합을 용이하게 하는 설계 기법
...
정황 시나리오 : 사용자의 요구사항을 도출하기 위해 작성하는 것. 사용자가 목표를 달성하기 위해 수행하는 방법을 순차적으로 묘사
